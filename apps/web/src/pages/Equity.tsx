  ...
  return (
    <div>
      ...
      <div className="mt-5 grid grid-cols-1 gap-5 xl:grid-cols-2">
        <Panel stagger={2} title="Underwater" hint="drawdown spans shaded on the curve, depth below" toolbar={ddSelect}>
          <Loadable
          ...
          >
            <div className="grid gap-2 p-4">
              <EquityChart points={focusCurve} shade={periods} height={200} />
